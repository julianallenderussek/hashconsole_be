...
async def create_user_project_role(user_project_role: UserProjectRoleCreate, db: Session = Depends(get_db)):
    db_user_project_role = UserProjectRoleModel(**user_project_role.dict())
